...
INDEX_SKILL_LINE = (
    "|Code Index Skill:.codex/skills/infoq-codebase-index:{SKILL.md,scripts/sync_indexes.py,"
    "references/usage.md,references/backend-index.md,references/frontend-react-index.md,"
    "references/frontend-vue-index.md}"
)
INDEX_REFRESH_LINE = (
    "|Code Index Refresh:Run python3 .codex/skills/infoq-codebase-index/scripts/sync_indexes.py "
...
def ensure_local_skill(line: str) -> str:
    prefix = "|Local Skills:.codex/skills:{"
    suffix = "}"
