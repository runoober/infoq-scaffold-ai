...
public class GlobalExceptionHandler {
    ...
    public ApiResult<Void> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException e,
        ...
        return ApiResult.fail(HttpStatus.HTTP_BAD_METHOD, e.getMessage());
    }
    ...
    public ApiResult<Void> handleServiceException(ServiceException e, HttpServletRequest request) {
        ...
        return ObjectUtil.isNotNull(code) ? ApiResult.fail(code, e.getMessage()) : ApiResult.fail(e.getMessage());
    }
    ...
    public ApiResult<Void> handleMissingPathVariableException(MissingPathVariableException e, HttpServletRequest request) {
        ...
        return ApiResult.fail(String.format("请求路径中缺少必需的路径变量[%s]", e.getVariableName()));
    }
    ...
    public ApiResult<Void> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e, HttpServletRequest request) {
        ...
        return ApiResult.fail(String.format("请求参数类型不匹配，参数[%s]要求类型为：'%s'，但输入值为：'%s'", e.getName(), Objects.requireNonNull(e.getRequiredType()).getName(), e.getValue()));
    }
    ...
    public ApiResult<Void> handleNoHandlerFoundException(NoHandlerFoundException e, HttpServletRequest request) {
        ...
        return ApiResult.fail(HttpStatus.HTTP_NOT_FOUND, e.getMessage());
    }
    ...
    public ApiResult<Void> constraintViolationException(ConstraintViolationException e) {
        log.error(e.getMessage());
    ...
    public ApiResult<Void> handlerMethodValidationException(HandlerMethodValidationException e) {
        log.error(e.getMessage());
    ...
    public ApiResult<Void> handleJsonParseException(JsonParseException e, HttpServletRequest request) {
        ...
        return ApiResult.fail(HttpStatus.HTTP_BAD_REQUEST, "请求数据格式错误（JSON 解析失败）：" + e.getMessage());
    }
    ...
    public ApiResult<Void> handleHttpMessageNotReadableException(HttpMessageNotReadableException e, HttpServletRequest request) {
        ...
        return ApiResult.fail(HttpStatus.HTTP_BAD_REQUEST, "请求参数格式错误：" + e.getMostSpecificCause().getMessage());
    }
    ...
    public ApiResult<Void> handleSpelException(ExpressionException e, HttpServletRequest request) {
        log.error("请求地址'{}'，SpEL解析异常: {}", request.getRequestURI(), e.getMessage());
        return ApiResult.fail(HttpStatus.HTTP_INTERNAL_ERROR, "SpEL解析失败：" + e.getMessage());
    }
}
