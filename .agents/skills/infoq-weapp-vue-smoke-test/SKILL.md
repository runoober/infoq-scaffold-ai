---
name: infoq-weapp-vue-smoke-test
description: Run deterministic smoke tests for infoq-scaffold-frontend-weapp-vue mini-program runtime, including full route checks and API contract coverage. Use when users ask for 小程序 Vue 冒烟测试, weapp-vue e2e, 接口覆盖验证, 全量路由验证, or Vue 小程序联调回归. This skill defaults to full suite and auto-login with captcha-safe guidance.
---

# Infoq Weapp Vue Smoke Test

## Overview

Run a repeatable weapp smoke flow for `infoq-scaffold-frontend-weapp-vue`:
...
bash .agents/skills/infoq-weapp-vue-smoke-test/scripts/run_smoke.sh --no-auto-login
...
- Workspace: `infoq-scaffold-frontend-weapp-vue`
- Suite: `full`
