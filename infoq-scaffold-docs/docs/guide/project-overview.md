...
> [!TIP]
> 内容真值源：[`doc/project-overview.md`](https://github.com/luckykuang/infoq-scaffold-ai/blob/main/doc/project-overview.md)
...
插件并不是“演示目录”，而是后端结构的一部分。哪些是固定基座、哪些是软开关，见 [`plugin-catalog.md`](/collaboration/plugin-catalog)。
...
- 想尽快联调：看 [`quick-start.md`](/guide/quick-start)
- 想理解后端：看 [`backend-handbook.md`](/backend/handbook)
- 想改管理端页面：看 [`admin-handbook.md`](/admin/handbook)
- 想改小程序：看 [`weapp-handbook.md`](/weapp/handbook)
- 想理解仓库规约：看 [`development-workflow.md`](/collaboration/development-workflow)
